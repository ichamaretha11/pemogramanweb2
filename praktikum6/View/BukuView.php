  ...
  <div class="container">
    ...
    <div class="col-12">
        ...
        <div class="my-3">
          ...
          data-bs-target="#tambaModal" class="btn btn-primary"><i class="bi bi-plus-circle"></i>Tambah</button>
         ...
         <tbody>
            ...
            <?php foreach($dataModel->getData() as $buku):?>
                <tr>
                    ...
                    <td>
                      <a href="/index.php/edit?id=1" class="btn  btn-sm btn-succes"><i class="bi-pencil-square"></i>
                    Edit</a>
                    <button data-bs-tonggle="modal" data-bs-target="#hapusModal"
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Konfirmasi Hapus Data</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
hpusModal.addEventListener('show.bs.modal', event => {
  ...
  const textid = hapusModal.querySelector('3textid')
